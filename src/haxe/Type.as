	...
	public class Type
	{
		...
		protected static function describe(t:*, fact:Boolean):Array
		{
			...
			var methods:XMLList = xml.child("method");
			{
				...
				{
					var i:int = _g1++;
					fields.push(Std1.string(methods[i].attribute("name")));
				}
			}
			var vars:XMLList = xml.child("variable");
			{
				...
				{
					var i1:int = _g11++;
					fields.push(Std1.string(vars[i1].attribute("name")));
				}
			}
			var accs:XMLList = xml.child("accessor");
			{
				...
				{
					var i2:int = _g12++;
					fields.push(Std1.string(accs[i2].attribute("name")));
				}
			}
			return fields;
		}
		...
		public static function _typeof(v:*):ValueType
		{
			...
			switch (cname)
			{
				...
				case "Number": 
				{
					if ((v < -268435456 || v >= 268435456) && Std1._int(v) == v)
						return ValueType.TInt;
